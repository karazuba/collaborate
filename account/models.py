...
class ThemePreference(BasePreference):
    ...
    class Meta:
        db_table = 'account_theme_preferences'
...
class CategoryPreference(BasePreference):
    ...
    class Meta:
        db_table = 'account_category_preferences'
        unique_together = ('profile', 'category')


class ProfilePreference(BasePreference):
    subject_profile = models.ForeignKey(to=Profile, on_delete=models.CASCADE,
                                        related_name='preference_set',
                                        related_query_name='preference')
    ...
    class Meta:
        db_table = 'account_profile_preferences'
